...
public class CaptchaController {
    ...
    @RequestMapping("/char")
    public String charCaptcha() {
        return "char";
    }

    @RequestMapping("/operation")
    public String operationCaptcha() {
        return "operation";
    }
    ...
    @ResponseBody
    @RequestMapping("/check/char/result")
    public String checkCharResult(String charCode) {
        if (captchaService.checkCharResult(charCode)) {
    ...
    @ResponseBody
    @RequestMapping("/check/operation/result")
    public String checkOperationResult(String charCode) {
        if (captchaService.checkOperationResult(charCode)) {
            return "check success";
        }
        return "check fail";
    }
