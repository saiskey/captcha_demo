...
(function ($, window, document, undefined) {
    ...
    MyCaptcha.prototype = {
        ...
        checkCaptcha: function () {
            ...
            $.get("/click/checkCaptcha", {"a": encClickPoint}, function (data) {
        ...
        load: function () {
            ...
            this.clickPoint = [];
            var _this = this;
            $.get("/click/captcha", {}, function (data) {
                if (data.status == "OK") {
                    ...
                    img.fadeOut("fast").attr("src", "/click/captchaImg?r=" + Math.random()).fadeIn("fast");
                } else {
